@extends('layouts.app', ['page' => __('Administración de usuarios'), 'pageSlug' => 'users'])
          ...
          <div class="card-body">
            <form method="post" action="{{ route('user.store') }}" autocomplete="off">
              ...
              <div class="pl-lg-4 row">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }} col-4">
                ...
                <div class="form-group{{ $errors->has('role_id') ? ' has-danger' : '' }} col-4">
                  <label class="form-control-label" for="input-rol">{{ __('Rol') }}</label>
                  <select class="form-control form-control-alternative{{ $errors->has('role_id') ? ' is-invalid' : '' }}" name="role_id" id="input-rol" required>
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }} col-4">
